...
func BenchmarkScanFiles(b *testing.B) {
	...
	for _, p := range []string{
		"github.com/tinygo-org/tinygo/alt_go/types/expr.go",
		"github.com/tinygo-org/tinygo/alt_go/parser/parser.go",
		"net/http/server.go",
		"github.com/tinygo-org/tinygo/alt_go/scanner/errors.go",
	} {
