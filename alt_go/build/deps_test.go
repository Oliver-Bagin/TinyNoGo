...
import (
	...
	"github.com/tinygo-org/tinygo/alt_go/internal/dag"
...
func TestFindImports(t *testing.T) {
	imports, err := findImports("github.com/tinygo-org/tinygo/alt_go/build")
	if err != nil {
		t.Fatal(err)
	}
	t.Logf("github.com/tinygo-org/tinygo/alt_go/build imports %q", imports)
