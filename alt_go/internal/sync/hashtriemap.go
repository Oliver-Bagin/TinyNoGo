...
func (ht *HashTrieMap[K, V]) Load(key K) (value V, ok bool) {
	...
	panic("github.com/tinygo-org/tinygo/alt_go/internal/sync.HashTrieMap: ran out of hash bits while iterating")
}
...
func (ht *HashTrieMap[K, V]) expand(oldEntry, newEntry *entry[K, V], newHash uintptr, hashShift uint, parent *indirect[K, V]) *node[K, V] {
	...
	for {
		if hashShift == 0 {
			panic("github.com/tinygo-org/tinygo/alt_go/internal/sync.HashTrieMap: ran out of hash bits while inserting")
		}
