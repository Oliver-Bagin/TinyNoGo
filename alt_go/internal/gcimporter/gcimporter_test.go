...
import (
	...
	. "github.com/tinygo-org/tinygo/alt_go/internal/gcimporter"
)
...
func TestImportTestdata(t *testing.T) {
	...
	testfiles := map[string][]string{
		"exports.go":  {"github.com/tinygo-org/tinygo/alt_go/ast", "github.com/tinygo-org/tinygo/alt_go/token"},
		"generics.go": nil,
	}
	testfiles["exports.go"] = []string{"github.com/tinygo-org/tinygo/alt_go/ast"}
...
var importedObjectTests = []struct {
	...
	{"github.com/tinygo-org/tinygo/alt_go/internal/exportdata.FindPkg", "func FindPkg(path string, srcDir string) (filename string, id string, err error)"},
...
func TestIssue13898(t *testing.T) {
	...
	fset := token.NewFileSet()
	imports := make(map[string]*types.Package)
	_, err := Import(fset, imports, "github.com/tinygo-org/tinygo/alt_go/internal/gcimporter", ".", nil)
	if err != nil {
		t.Fatal(err)
	}
