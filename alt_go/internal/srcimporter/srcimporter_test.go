...
func TestIssue20855(t *testing.T) {
	...
	pkg, err := importer.ImportFrom("github.com/tinygo-org/tinygo/alt_go/internal/srcimporter/testdata/issue20855", ".", 0)
...
func TestIssue24392(t *testing.T) {
	testImportPath(t, "github.com/tinygo-org/tinygo/alt_go/internal/srcimporter/testdata/issue24392")
}
