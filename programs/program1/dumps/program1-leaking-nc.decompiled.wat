...
data data_2(offset: 87072) =
  "P]\01\00\c1\82\01\00\00\00\00\00\04\00\00\00\0c\00\00\00\01\00\00\00\00"
...
function runtime_alloc(a:int):int { // func46
  ...
  a = {
        ...
        if (eqz(g_b)) {
          89336[0]:long = 89336[0]:long + 1L;
          89320[0]:int = (a = (b = a + 15 & -16) + (c = 89320[0]:int));
          89328[0]:long = 89328[0]:long + i64_extend_i32_u(b);
          b = 89180[0]:int;
        }
        if (eqz(g_b)) {
          loop L_g {
...
function Push(a:int_ptr) { // func71
  ...
  a = {
        ...
        if (eqz(g_b)) {
          var c:int_ptr = 89404[0]:int;
          if (c) { c[0] = a }
          89404[0]:int = a;
          if (a) {
            a[0] = 0;
            if (eqz(89400[0]:int)) { 89400[0]:int = a }
            return ;
          }
        }
        if (eqz(g_b) | eqz(b)) {
...
function runtime_putchar(a:int) { // func78
  ...
  a = {
        ...
        if (eqz(g_b) | eqz(c)) {
          runtime_fd_write(1, 87012, 1, 89344);
          0;
          if (g_b == 1) goto B_a;
        }
  ...
  b = {
        ...
        loop L_l {
          ...
          if (eqz(g_b)) {
            ...
            if (c) goto B_r;
            var g:long = a[1]:long;
            c = g > e - (h = 89416[0]:long);
            if (c) goto B_r;
            89416[0]:long = g + h;
            89408[0]:int = (c = a[0]:int);
            a[0]:int = 0;
          }
          if (eqz(g_b) | d == 6) {
            Push(a);
          ...
          if (eqz(g_b)) {
            if (eqz(c)) {
              89400[0]:int = a[0]:int;
              if (a == 89404[0]:int) { 89404[0]:int = 0 }
              a[0]:int = 0;
              f = 89176[0]:int;
              89176[0]:int = a;
              c = a + 16;
            ...
            c = eqz(a);
            if (c) goto B_o;
            h = a[1]:long + 89416[0]:long - e;
            a = h <= 0L;
            if (a) continue L_l;
            87048[0]:long = h;
          }
          if (eqz(g_b) | d == 7) {
            runtime_poll_oneoff(87024, 89360, 1, 89392);
            let t3 = 7;
            if (g_b == 1) goto B_b;
            a = t3;
          }
...
function runtime_run_1() { // func90
  ...
  b = {
        ...
        f = {
              ...
              if (eqz(g_b)) {
                if (eqz(89408[0]:int)) { 89416[0]:long = g }
                a = 89408;
                loop L_za {
                  0;
...
function runtime_Gosched() { // func95
  var c:long;
  var a:int;
  var b:int;
  if (g_b == 2) {
  ...
  b = {
        ...
        if (eqz(g_b)) {
          89312[0]:long = (c = 89312[0]:long + 1L);
          a = c % 100L != 0L;
        }
        if (eqz(g_b)) {
          if (a) goto B_e;
...
function runtime_hashmapGet(a:int_ptr, b:int, c:int, d:int):int { // func106
  var f:int_ptr;
  var g:int;
  var j:int;
  var h:int;
...
function runtime_hashmapBucketAddrForHash(a:int, b:int):int { // func107
  return a[0]:int +
         ((a[4]:int + a[3]:int << 3) + 12) *
         (select_if(-1, -1 << (a = a[20]:ubyte) ^ -1, a > 31) & b)
}

function runtime_hashmapSet(a:int, b:int, c:int, d:int) { // func108
  var l:long_ptr;
  var f:int_ptr;
  var h:int;
  var g:int_ptr;
...
function runtime_fastrand():int { // func109
  var a:int;
  data[0]:int =
...
function runtime_hashmapNext(a:int, b:int, c:int, d:int):int { // func110
  var e:int_ptr;
  var h:int;
  var i:int;
  var g:int;
...
function runtime_reflectValueEqual(a:ubyte_ptr, b:int, c:int, d:int, e:int, f:int):int { // func111
  var h:int;
  var i:int;
  var l:int;
  var j:int;
...
function runtime_stringLess(a:ubyte_ptr, b:int, c:ubyte_ptr, d:int):int { // func113
  var f:int;
  var g:int;
...
function runtime_stringFromUnicode(a:{ a:int, b:int }, b:int) { // func114
  var c:int;
  var e:int;
  var g:int;
  var d:{ a:int, b:int, c:int }
...
function Elem_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int) { // func115
  var e:int;
  var f:{ a:int, b:int, c:int, d:int, e:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 20;
...
function Field_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int, e:int) { // func116
  var f:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 24;
...
function Index_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int, e:int) { // func117
  var f:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 24;
...
function internal_fmtsort_Sort_1(a:int, b:int, c:int, d:{ a:int, b:int, c:int, d:int, e:int, f:int }, e:int, f:int, g:int, h:int, i:int, j:int, k:int, l:int):int { // func118
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 24;
    d = g_c[0]:int;
    a = d.a;
...
function internal_fmtsort_compare(a:ubyte_ptr, b:int, c:int, d:int, e:int, f:int):int { // func119
  var i:int;
  var j:int;
  var g:int;
  var n:long;
...
function slices_insertionSortCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:int, d:int) { // func120
  var g:int;
  var o:int;
  var k:int;
  var f:int;
...
function slices_symMergeCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:int, d:int, e:int) { // func121
  var h:int;
  var f:int;
...
function slices_swapRangeCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:long_ptr@4, d:int, e:int) { // func122
  var o:int;
  var i:int;
  a = {
        if (g_b == 2) {
...
function cmp_isNaN_string(a:int, b:int):int { // func123
  return runtime_stringEqual(a, b, a, b) ^ 1
}

function internal_fmtsort_nilCompare(a:{ a:int, b:byte }, b:int, c:int, d:int, e:int, f:int, g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }) { // func124
  var i:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 28;
    g = g_c[0]:int;
...
function time_appendInt(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int, f:int) { // func125
  var h:int;
  var g:int;
  var k:int;
  var j:int;
...
function lookup(a:{ a:int, b:int, c:int }, b:int, c:long) { // func126
  var g:ubyte_ptr;
  var e:int;
  var n:int;
  var f:int;
...
function time_tzsetName(a:{ a:int, b:int, c:int, d:int, e:byte }, b:ubyte_ptr, c:int) { // func127
  var g:int;
  var e:int;
  var h:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var d:int;
...
function time_tzsetOffset(a:{ a:int, b:int, c:int, d:byte }, b:ubyte_ptr, c:ubyte_ptr) { // func128
...
function time_tzsetRule(a:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:byte }, b:ubyte_ptr, c:ubyte_ptr) { // func129
...
function yearYday(a:{ a:int, b:int }, b:long) { // func130
  var d:int;
  var f:int;
  var e:int;
...
function time_tzruleTime(a:int, b:int, c:int, d:int, e:int, f:int, g:int):int { // func131
  var h:int;
  var i:int;
...
function time_tzsetNum(a:{ a:int, b:int, c:int, d:byte }, b:int, c:int, d:int, e:int) { // func132
  var j:int;
  var i:int;
...
function split(a:{ a:long, b:int, c:int }, b:long) { // func133
  var c:long;
...
function date(a:{ a:int, b:int, c:int }, b:long) { // func134
  var d:int;
  var e:int;
...
function clock(a:{ a:int, b:int, c:int }, b:long) { // func135
  var c:int;
  var d:int;
...
function String_6(a:{ a:int, b:int }, b:int) { // func136
  var d:int;
  var c:int;
  var g:long;
  var f:{ a:int, b:int, c:int, d:int, e:int }
...
function Write(a:{ a:int, b:int, c:int }, b:int, c:int, d:int) { // func137
  var e:{ a:int, b:int, c:int, d:int, e:int }
  var f:{ a:int, b:int, c:int, d:int, e:int } = 
    {
...
function Write_1(a:{ a:int, b:int, c:int }, b:int, c:int, d:int) { // func138
  var h:int_ptr;
  var e:int;
  var f:int;
  var i:int;
...
function strconv_appendQuotedWith(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int) { // func139
  var f:int;
  var g:int;
  var m:int;
  var k:int;
...
function strconv_IsPrint(a:int):int { // func140
  var c:int;
  var b:int;
  var d:int;
  var g:int;
...
function strconv_bsearch_uint16_uint16(a:{ a:int, b:byte }, b:int, c:int, d:int) { // func141
  var e:int;
  var j:int;
  var h:int;
  a = {
...
function strconv_leftShift(a:int, b:int) { // func142
  var d:int;
  var c:int;
  var f:ubyte_ptr;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int }
...
function strconv_trim(a:int_ptr) { // func143
  var c:int;
  a = {
        if (g_b == 2) {
          g_c[0]:int = g_c[0]:int - 4;
...
function strconv_rightShift(a:int, b:int) { // func144
  var d:int;
  var c:int;
  var i:int;
  var h:byte_ptr;
...
function strconv_formatDigits(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:ubyte_ptr, f:int, g:int, h:int, i:int, j:int) { // func145
  var k:int;
  var o:int;
...
function strconv_mult128bitPow10(a:{ a:long, b:int, c:byte }, b:long, c:int, d:int) { // func146
  var f:int;
  var g:long;
  var h:long;
  a = 
...
function strconv_divisibleByPower5(a:long, b:int):int { // func147
  var d:long;
  var c:int;
  if (eqz(a)) {
    c = 1;
...
function strconv_formatDecimal(a:int_ptr, b:long, c:int, d:int, e:byte_ptr) { // func148
  var k:int;
  var i:long;
  var h:long;
  var g:int;
...
function strconv_mult64bitPow10(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int) { // func149
  var g:long;
  var f:int;
  a = 
    {
...
function strconv_ryuDigits(a:{ a:int, b:int, c:int, d:int, e:int }, b:long, c:long, d:long, e:int, f:int) { // func150
  var k:int_ptr;
  var j:int;
  var n:int;
  var l:int;
...
function strconv_divmod1e9(a:{ a:int, b:int }, b:long) { // func151
  var d:long;
...
function strconv_ryuDigits32(a:int_ptr, b:{ a:int, b:int }, c:int, d:int, e:int, f:int, g:{ a:int, b:int }) { // func152
  var i:int;
  var h:int;
  var j:int;
  if (g_b == 2) {
...
function write_1(a:int, b:int, c:int) { // func153
  var g:{ a:long, b:int }
  var f:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var h:int;
...
function writeByte(a:int, b:int) { // func154
  var e:int;
  var f:int;
  var c:{ a:int, b:int, c:int, d:int, e:int, f:int }
  var g:int;
...
function writeString(a:int, b:int, c:int) { // func155
  var g:{ a:long, b:int }
  var f:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var h:int;
...
function fmtInteger(a:int, b:long, c:int, d:int, e:ubyte_ptr) { // func156
  var k:int;
  var g:int;
  var l:long;
  var m:int;
...
function writePadding(a:int, b:{ a:int, b:int, c:int }) { // func157
  var f:int;
  var e:int;
  var h:int;
  var g:int;
...
function pad(a:int, b:int, c:int, d:int) { // func158
  var i:int_ptr;
  var f:int;
  var k:int;
  var j:byte_ptr;
...
function fmtS(a:int, b:int, c:int) { // func159
  var f:int_ptr;
  var e:{ a:int, b:int, c:int, d:int, e:int }
  var d:{ a:int, b:int, c:int, d:int, e:int }
  if (g_b == 2) {
...
function truncateString(a:{ a:int, b:int }, b:int, c:int, d:int) { // func160
  var h:int;
  var g:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
...
function padString(a:int, b:int, c:int) { // func161
  var e:int;
  var d:{ a:int, b:int, c:int, d:int, e:int }
  var f:int;
  if (g_b == 2) {
...
function fmt0x64(a:int, b:long, c:int) { // func162
  var e:int;
  var d:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 20;
...
function fmtBool(a:int, b:int) { // func163
  var c:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function fmtComplex(a:int, b:double, c:double, d:int) { // func164
  var e:int;
  var f:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 28;
...
function fmtFloat(a:int, b:double, c:int) { // func165
  var f:int;
  var d:{ a:int, b:int, c:int }
  var k:int;
  var g:ubyte_ptr;
...
function fmtInteger_1(a:ubyte_ptr, b:long, c:int) { // func166
  var e:int;
  var d:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 16;
...
function fmtString(a:ubyte_ptr, b:int, c:int) { // func167
  var d:int_ptr;
  var g:int;
...
function handleMethods(a:int):int { // func168
  var b:int;
  var c:int;
  var d:int;
  var g:int;
...
function printArg(a:int, b:int, c:int) { // func169
  var j:long_ptr;
  var d:int_ptr;
  var f:int;
  var e:long;
...
function printValue(a:int, b:int, c:int, d:int, e:ubyte_ptr) { // func170
...
function main_boring(a:int, b:int) { // func171
  var c:int;
  var f:int_ptr;
  var h:int;
  var i:int;
...
export function asyncify_start_unwind(a:int) { // func172
  g_b = 1;
  g_c = a;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_stop_unwind() { // func173
  g_b = 0;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_start_rewind(a:int) { // func174
  g_b = 2;
  g_c = a;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_stop_rewind() { // func175
  g_b = 0;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_get_state():int { // func176
  return g_b
}
