...
function runtime_panicOrGoexit(a:int, b:{ a:int, b:int }) { // func96
  var c:{ a:int, b:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 8;
    b = g_c[0]:int;
...
function runtime_printitf(a:int, b:int) { // func97
  var e:int;
  var c:int;
  var d:int;
  var f:long;
...
function runtime_printint32(a:int) { // func98
  var b:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function interface_Error_func_string_typeassert(a:int):int { // func99
  return 
...
function interface_String_func_string_typeassert(a:int):int { // func100
  return 
...
function interface_String_func_string_String_invoke(a:{ a:int, b:int }, b:int, c:int) { // func101
  var e:int_ptr;
  var d:int;
  var f:int;
  var h:long;
...
function String_3(a:{ a:int, b:int }, b:long, c:long, d:int) { // func102
  var f:ubyte_ptr;
  var e:int;
  var n:int;
...
function get(a:{ a:int, b:int, c:int }):int { // func103
  var d:int;
  var b:int;
  var c:{ a:int, b:int, c:int }
  if (g_b == 2) {
...
function String_4(a:{ a:int, b:int }, b:int) { // func104
  var c:{ a:int, b:int, c:int, d:int }
  var e:int;
  var d:{ a:int, b:int, c:int, d:int }
  if (g_b == 2) {
...
function String_5(a:{ a:int, b:int }, b:int) { // func105
  var c:int;
...
function main_boring_gowrapper(a:{ a:int, b:int }) { // func106
  var b:{ a:int, b:int }
  var c:{ a:int, b:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 8;
...
function runtime_hashmapGet(a:int_ptr, b:int, c:int, d:int):int { // func107
  var f:int_ptr;
  var g:int;
  var j:int;
  var h:int;
...
function runtime_hashmapBucketAddrForHash(a:int, b:int):int { // func108
  return a[0]:int +
         ((a[4]:int + a[3]:int << 3) + 12) *
         (select_if(-1, -1 << (a = a[20]:ubyte) ^ -1, a > 31) & b)
}

function runtime_hashmapSet(a:int, b:int, c:int, d:int) { // func109
  var l:long_ptr;
  var f:int_ptr;
  var h:int;
  var g:int_ptr;
...
function runtime_fastrand():int { // func110
  var a:int;
  data[0]:int =
...
function runtime_hashmapNext(a:int, b:int, c:int, d:int):int { // func111
  var e:int_ptr;
  var h:int;
  var i:int;
  var g:int;
...
function runtime_reflectValueEqual(a:ubyte_ptr, b:int, c:int, d:int, e:int, f:int):int { // func112
  var h:int;
  var i:int;
  var l:int;
  var j:int;
...
function runtime_stringEqual(a:ubyte_ptr, b:int, c:ubyte_ptr, d:int):int { // func113
  var e:int;
  if (b != d) goto B_a;
  b = select_if(b, 0, b > 0);
  loop L_b {
...
function runtime_stringLess(a:ubyte_ptr, b:int, c:ubyte_ptr, d:int):int { // func114
  var f:int;
  var g:int;
...
function runtime_stringFromUnicode(a:{ a:int, b:int }, b:int) { // func115
  var c:int;
  var e:int;
  var g:int;
  var d:{ a:int, b:int, c:int }
...
function Elem_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int) { // func116
  var e:int;
  var f:{ a:int, b:int, c:int, d:int, e:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 20;
...
function Field_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int, e:int) { // func117
  var f:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 24;
...
function Index_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int, e:int) { // func118
  var f:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 24;
...
function internal_fmtsort_Sort_1(a:int, b:int, c:int, d:{ a:int, b:int, c:int, d:int, e:int, f:int }, e:int, f:int, g:int, h:int, i:int, j:int, k:int, l:int):int { // func119
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 24;
    d = g_c[0]:int;
    a = d.a;
...
function internal_fmtsort_compare(a:ubyte_ptr, b:int, c:int, d:int, e:int, f:int):int { // func120
  var i:int;
  var j:int;
  var g:int;
  var n:long;
...
function slices_insertionSortCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:int, d:int) { // func121
  var g:int;
  var o:int;
  var k:int;
  var f:int;
...
function slices_symMergeCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:int, d:int, e:int) { // func122
  var h:int;
  var f:int;
...
function slices_swapRangeCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:long_ptr@4, d:int, e:int) { // func123
  var o:int;
  var i:int;
  a = {
        if (g_b == 2) {
...
function cmp_isNaN_string(a:int, b:int):int { // func124
  return runtime_stringEqual(a, b, a, b) ^ 1
}

function internal_fmtsort_nilCompare(a:{ a:int, b:byte }, b:int, c:int, d:int, e:int, f:int, g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }) { // func125
  var i:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 28;
    g = g_c[0]:int;
...
function time_appendInt(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int, f:int) { // func126
  var h:int;
  var g:int;
  var k:int;
  var j:int;
...
function lookup(a:{ a:int, b:int, c:int }, b:int, c:long) { // func127
  var g:ubyte_ptr;
  var e:int;
  var n:int;
  var f:int;
...
function time_tzsetName(a:{ a:int, b:int, c:int, d:int, e:byte }, b:ubyte_ptr, c:int) { // func128
  var g:int;
  var e:int;
  var h:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var d:int;
...
function time_tzsetOffset(a:{ a:int, b:int, c:int, d:byte }, b:ubyte_ptr, c:ubyte_ptr) { // func129
...
function time_tzsetRule(a:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:byte }, b:ubyte_ptr, c:ubyte_ptr) { // func130
...
function yearYday(a:{ a:int, b:int }, b:long) { // func131
  var d:int;
  var f:int;
  var e:int;
...
function time_tzruleTime(a:int, b:int, c:int, d:int, e:int, f:int, g:int):int { // func132
  var h:int;
  var i:int;
...
function time_tzsetNum(a:{ a:int, b:int, c:int, d:byte }, b:int, c:int, d:int, e:int) { // func133
  var j:int;
  var i:int;
...
function split(a:{ a:long, b:int, c:int }, b:long) { // func134
  var c:long;
...
function date(a:{ a:int, b:int, c:int }, b:long) { // func135
  var d:int;
  var e:int;
...
function clock(a:{ a:int, b:int, c:int }, b:long) { // func136
  var c:int;
  var d:int;
...
function String_6(a:{ a:int, b:int }, b:int) { // func137
  var d:int;
  var c:int;
  var g:long;
  var f:{ a:int, b:int, c:int, d:int, e:int }
...
function Write(a:{ a:int, b:int, c:int }, b:int, c:int, d:int) { // func138
  var e:{ a:int, b:int, c:int, d:int, e:int }
  var f:{ a:int, b:int, c:int, d:int, e:int } = 
    {
...
function Write_1(a:{ a:int, b:int, c:int }, b:int, c:int, d:int) { // func139
  var h:int_ptr;
  var e:int;
  var f:int;
  var i:int;
...
function strconv_appendQuotedWith(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int) { // func140
  var f:int;
  var g:int;
  var m:int;
  var k:int;
...
function strconv_IsPrint(a:int):int { // func141
  var c:int;
  var b:int;
  var d:int;
  var g:int;
...
function strconv_bsearch_uint16_uint16(a:{ a:int, b:byte }, b:int, c:int, d:int) { // func142
  var e:int;
  var j:int;
  var h:int;
  a = {
...
function strconv_leftShift(a:int, b:int) { // func143
  var d:int;
  var c:int;
  var f:ubyte_ptr;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int }
...
function strconv_trim(a:int_ptr) { // func144
  var c:int;
  a = {
        if (g_b == 2) {
          g_c[0]:int = g_c[0]:int - 4;
...
function strconv_rightShift(a:int, b:int) { // func145
  var d:int;
  var c:int;
  var i:int;
  var h:byte_ptr;
...
function strconv_formatDigits(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:ubyte_ptr, f:int, g:int, h:int, i:int, j:int) { // func146
  var k:int;
  var o:int;
...
function strconv_mult128bitPow10(a:{ a:long, b:int, c:byte }, b:long, c:int, d:int) { // func147
  var f:int;
  var g:long;
  var h:long;
  a = 
...
function strconv_divisibleByPower5(a:long, b:int):int { // func148
  var d:long;
  var c:int;
  if (eqz(a)) {
    c = 1;
...
function strconv_formatDecimal(a:int_ptr, b:long, c:int, d:int, e:byte_ptr) { // func149
  var k:int;
  var i:long;
  var h:long;
  var g:int;
...
function strconv_mult64bitPow10(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int) { // func150
  var g:long;
  var f:int;
  a = 
    {
...
function strconv_ryuDigits(a:{ a:int, b:int, c:int, d:int, e:int }, b:long, c:long, d:long, e:int, f:int) { // func151
  var k:int_ptr;
  var j:int;
  var n:int;
  var l:int;
...
function strconv_divmod1e9(a:{ a:int, b:int }, b:long) { // func152
  var d:long;
...
function strconv_ryuDigits32(a:int_ptr, b:{ a:int, b:int }, c:int, d:int, e:int, f:int, g:{ a:int, b:int }) { // func153
  var i:int;
  var h:int;
  var j:int;
  if (g_b == 2) {
...
function write_1(a:int, b:int, c:int) { // func154
  var g:{ a:long, b:int }
  var f:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var h:int;
...
function writeByte(a:int, b:int) { // func155
  var e:int;
  var f:int;
  var c:{ a:int, b:int, c:int, d:int, e:int, f:int }
  var g:int;
...
function writeString(a:int, b:int, c:int) { // func156
  var g:{ a:long, b:int }
  var f:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var h:int;
...
function fmtInteger(a:int, b:long, c:int, d:int, e:ubyte_ptr) { // func157
  var k:int;
  var g:int;
  var l:long;
  var m:int;
...
function writePadding(a:int, b:{ a:int, b:int, c:int }) { // func158
  var f:int;
  var e:int;
  var h:int;
  var g:int;
...
function pad(a:int, b:int, c:int, d:int) { // func159
  var i:int_ptr;
  var f:int;
  var k:int;
  var j:byte_ptr;
...
function fmtS(a:int, b:int, c:int) { // func160
  var f:int_ptr;
  var e:{ a:int, b:int, c:int, d:int, e:int }
  var d:{ a:int, b:int, c:int, d:int, e:int }
  if (g_b == 2) {
...
function truncateString(a:{ a:int, b:int }, b:int, c:int, d:int) { // func161
  var h:int;
  var g:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
...
function padString(a:int, b:int, c:int) { // func162
  var e:int;
  var d:{ a:int, b:int, c:int, d:int, e:int }
  var f:int;
  if (g_b == 2) {
...
function fmt0x64(a:int, b:long, c:int) { // func163
  var e:int;
  var d:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 20;
...
function fmtBool(a:int, b:int) { // func164
  var c:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function fmtComplex(a:int, b:double, c:double, d:int) { // func165
  var e:int;
  var f:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 28;
...
function fmtFloat(a:int, b:double, c:int) { // func166
  var f:int;
  var d:{ a:int, b:int, c:int }
  var k:int;
  var g:ubyte_ptr;
...
function fmtInteger_1(a:ubyte_ptr, b:long, c:int) { // func167
  var e:int;
  var d:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 16;
...
function fmtString(a:ubyte_ptr, b:int, c:int) { // func168
  var d:int_ptr;
  var g:int;
...
function handleMethods(a:int):int { // func169
  var b:int;
  var c:int;
  var d:int;
  var g:int;
...
function printArg(a:int, b:int, c:int) { // func170
  var j:long_ptr;
  var d:int_ptr;
  var f:int;
  var e:long;
...
function printValue(a:int, b:int, c:int, d:int, e:ubyte_ptr) { // func171
...
function main_boring(a:int, b:int) { // func172
  var c:int;
  var f:int_ptr;
  var i:int;
  var h:int;
...
export function asyncify_start_unwind(a:int) { // func173
  g_b = 1;
  g_c = a;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_stop_unwind() { // func174
  g_b = 0;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_start_rewind(a:int) { // func175
  g_b = 2;
  g_c = a;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_stop_rewind() { // func176
  g_b = 0;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_get_state():int { // func177
  return g_b
}
