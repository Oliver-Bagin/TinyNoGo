...
function Add(a:{ a:int, b:int }, b:int_ptr) { // func118
  var e:int;
  var d:{ a:int, b:int, c:int, d:int }
  var c:{ a:int, b:int, c:int, d:int }
  var g:int;
...
function main_main_1_gowrapper(a:int) { // func119
  var b:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function main_main_gowrapper(a:int) { // func120
  var b:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function Wait(a:int_ptr) { // func121
  var b:{ a:int, b:int }
  var c:{ a:int, b:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 8;
...
function main_printMemoryTable(a:int) { // func122
  var c:int;
  var h:int;
  var b:byte_ptr;
  var m:int;
        ...
        loop L_n {
          if (eqz(g_b)) {
            ...
            loop L_p {
              ...
              l = i > 7;
              if (l) goto B_i;
              if ((j + 86708)[0]:ubyte == 37) goto B_q;
              e = e + 1;
              f = f + 1;
              b = b + 1;
              continue L_p;
...
function main_main_3_gowrapper(a:int) { // func123
  var b:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function main_main_4_gowrapper(a:int) { // func124
  var b:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function runtime_hashmapInterfaceEqual(a:{ a:int, b:int }, b:{ a:int, b:int }, c:int_ptr, d:int):int { // func138
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int }
  var g:int;
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int }
  if (g_b == 2) {
...
function runtime_interfaceEqual(a:int, b:int, c:int, d:int):int { // func139
  var g:int_ptr;
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int }
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int }
  if (g_b == 2) {
...
function runtime_reflectValueEqual(a:ubyte_ptr, b:int, c:int, d:int, e:int, f:int):int { // func140
  var h:int;
  var k:int;
  var l:int;
  var i:int;
...
function runtime_hashmapInterfacePtrHash(a:{ a:int, b:int }, b:{ a:int, b:int, c:int, d:int }, c:int, d:int):int { // func141
  var e:{ a:int, b:int, c:int, d:int, e:int }
...
function runtime_hashmapInterfaceHash(a:ubyte_ptr, b:int, c:int):int { // func142
  var e:int;
  var g:int;
  var h:int;
  var f:int_ptr;
...
function runtime_hashmapFloat32Hash(a:int_ptr, b:int):int { // func143
  var e:{ a:int, b:int, c:int, d:int }
  var f:int;
  var g:int;
  var d:int_ptr;
...
function runtime_hashmapFloat64Hash(a:long_ptr, b:int):int { // func144
  var e:{ a:int, b:int, c:int, d:int }
  var f:int;
  var g:int;
  var d:long_ptr;
