...
function runtime_run_1() { // func99
  ...
  d = {
        ...
        if (eqz(g_b)) {
          ...
          stack_pointer = a;
          a[21]:int = 38;
          memory_fill(a + 96, 0, 144);
          a[20]:int = (l = 90036[0]:int);
          90036[0]:int = (c = a + 80);
          b = 0;
        }
        if (eqz(g_b) | eqz(e)) {
        ...
        if (eqz(g_b)) { 89828[0]:int = (c = memory_size() << 16) }
        if (eqz(g_b) | e == 1) {
          runtime_ticks();
          let t0 = 1;
          if (g_b == 1) goto B_b;
        ...
        if (eqz(g_b) | e == 2) {
          runtime_sliceAppend(c, 0, 87784, 0, 0, 1, 16);
          2;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) {
          90648[0]:long@4 = (j = a[11]:long@4);
          90644[0]:int = (f = a[10]:int);
          a[22]:int = f;
          a[23]:int = (i = 90044[0]:int);
          c = eqz(i);
        }
        if (eqz(g_b)) {
          if (eqz(c)) {
        ...
        loop L_za {
          ...
          if (eqz(g_b)) {
            89968[0]:long = (k = 89968[0]:long + 1L);
            a[42]:int = h;
            j = k % 1000L;
            c = j != 0L;
          }
          if (eqz(g_b)) {
            if (c) goto B_eb;
            a[43]:int = (b = 89824[0]:int);
          }
          if (eqz(g_b) | e == 18) {
            runtime_scheduleLogTask(67792, 8, b);
            18;
            if (g_b == 1) goto B_b;
          }
          if (eqz(g_b)) { a[44]:int = (b = 89824[0]:int) }
          if (eqz(g_b) | e == 19) {
            Push(b);
            19;
            if (g_b == 1) goto B_b;
        ...
        if (eqz(g_b)) {
          b[0]:long = j - k >> 16L & 17592186044415L;
          a[47]:int = b;
          a[48]:int = b;
          a[19]:int = b;
          a[18]:int = 86840;
        ...
        if (eqz(g_b) | e == 24) {
          fmt_Printf(g, 86856, 15, c);
          24;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) { a[49]:long@4 = a[2]:long }
        if (eqz(g_b) | e == 25) {
          runtime_alloc(8);
          let t11 = 25;
          if (g_b == 1) goto B_b;
        ...
        if (eqz(g_b) | e == 26) {
          fmt_Printf(g, 86871, 20, c);
          26;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) { a[53]:long@4 = a[1]:long }
        if (eqz(g_b) | e == 27) {
          runtime_alloc(8);
          let t12 = 27;
          if (g_b == 1) goto B_b;
        ...
        if (eqz(g_b)) {
          b[0]:long = i64_extend_i32_u(f - 90688 >> 20);
          a[55]:int = b;
          a[56]:int = b;
          a[15]:int = b;
          a[14]:int = 86840;
        ...
        if (eqz(g_b) | e == 28) {
          fmt_Printf(a, 86891, 13, c);
          28;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) {
          a[57]:long@4 = a[0]:long;
...
function fmt_newPrinter():int { // func128
  var b:int_ptr;
  var a:int;
  var c:int;
  var d:{ a:int, b:int, c:int, d:int, e:int }
...
function writeByte(a:int, b:int) { // func129
  var c:int;
  var g:int;
  var f:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
...
function printArg(a:int, b:int, c:int, d:int) { // func130
  var i:int_ptr;
  var g:int;
  var e:int;
  var f:long;
...
function Write(a:{ a:int, b:int, c:int }, b:int_ptr, c:int, d:int) { // func131
  var e:int_ptr;
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int }
  var g:int;
  var i:int;
...
function fmt_Printf(a:{ a:int, b:int }, b:byte_ptr, c:int, d:{ a:int, b:int }) { // func133
  var h:int;
  var j:int;
  var g:int;
  var e:byte_ptr;
