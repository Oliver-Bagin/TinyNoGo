...
function runtime_run_1() { // func95
  ...
  d = {
        ...
        if (eqz(g_b)) {
          if (f) goto B_m;
          a[26]:int = (h = runtime_alloc(b << 2));
          c = a[18]:int;
          f = c < 0;
          if (f) goto B_m;
          a[27]:int = (e = runtime_alloc(c));
          a[28]:int = e;
          f = eqz(c);
          if (f) goto B_l;
        }
        if (eqz(g_b) | g == 1) {
          runtime_args_get(h, e);
          let t1 = 1;
          if (g_b == 1) goto B_b;
          f = t1;
        }
        if (eqz(g_b)) {
          f = b > 536870911;
          if (f) goto B_m;
          89540[0]:int = (i = runtime_alloc(b << 3));
          89544[0]:int = b;
          89548[0]:int = b;
          a[29]:int = i;
          e = i;
        ...
        if (eqz(g_b) | g == 4) {
          runtime_clock_time_get(0, 1000L, b);
          let t2 = 4;
          if (g_b == 1) goto B_b;
          b = t2;
        }
        ...
        loop L_ba {
          ...
          if (select_if(select_if(g_b, 1, b), 0, eqz(g_b) | g == 6)) {
            writeByte(h, 32);
            6;
            if (g_b == 1) goto B_b;
          }
        ...
        if (eqz(g_b) | g == 12) {
          fmt_Printf(f, 86400, 15, b);
          12;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) {
          a[49]:long@4 = a[3]:long;
          c = runtime_alloc(8);
          c[0] = m >> 20L;
          a[51]:int = c;
          a[52]:int = c;
        ...
        if (eqz(g_b) | g == 13) {
          fmt_Printf(f, 86415, 20, b);
          13;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) {
          a[53]:long@4 = a[2]:long;
          c = runtime_alloc(8);
          c[0] = i64_extend_i32_u(e - 89968 >> 20);
          a[55]:int = c;
          a[56]:int = c;
          a[17]:int = c;
          a[16]:int = 86384;
  ...
  c = 
    {
      ...
      loop L_d {
        if (eqz(g_b)) {
          89464[0]:long = (e = 89464[0]:long + 1L);
          a = e % 100L != 0L;
        }
        if (eqz(g_b)) {
          if (a) goto B_f;
          ...
          if (eqz(g_b)) {
            if (eqz(89529[0]:ubyte)) {
              ...
              loop L_t {
                b = 89480[0]:int <= a;
                if (eqz(b)) {
                  br_table[B_z, B_y, B_x, ..B_u]((state(a) & 255) - 1)
                  label B_z:
                  markFree(a);
...
function runtime_markRoots(a:int_ptr, b:int) { // func103
  var d:int;
  var c:{ a:int, b:int, c:int, d:int }
  var e:{ a:int, b:int, c:int, d:int }
  if (g_b == 2) {
...
function markFree(a:int) { // func104
  var b:int = 89472[0]:int + (a >> 2);
  b[0]:byte = b[0]:ubyte & (3 << (a << 1 & 6) ^ -1);
}

function runtime_startMark(a:int) { // func105
  var h:int;
  var f:int;
  a = {
        if (g_b == 2) {
...
function runtime_panicOrGoexit(a:int, b:{ a:int, b:int }) { // func106
  var c:{ a:int, b:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 8;
    b = g_c[0]:int;
...
function runtime_printitf(a:int, b:int) { // func107
  var e:int;
  var f:int;
  var c:int;
  var d:int;
...
function interface_Error_func_string_typeassert(a:int):int { // func108
  return 
...
function interface_String_func_string_typeassert(a:int):int { // func109
  return 
...
function interface_String_func_string_String_invoke(a:{ a:int, b:int }, b:int, c:{ a:int, b:int }) { // func110
  var d:int_ptr;
  var e:int;
  var g:int;
  var h:long;
...
function String_3(a:{ a:int, b:int }, b:long, c:long, d:int) { // func111
  var e:int;
  var k:int;
...
function get(a:{ a:int, b:int, c:int }):int { // func112
  var b:int;
  var e:{ a:int, b:int, c:int, d:int }
  var d:int;
  var c:{ a:int, b:int, c:int, d:int }
...
function String_4(a:{ a:int, b:int }, b:int) { // func113
  var e:int_ptr;
  var f:int;
...
function String_5(a:{ a:int, b:int }, b:int) { // func114
  var c:int;
...
function findHead(a:int):int { // func115
  var b:int;
...
function runtime_hashmapGet(a:int_ptr, b:int, c:int, d:int):int { // func122
  var f:int;
  var j:int;
  var h:int_ptr;
  var g:int;
...
function runtime_hashmapBucketAddrForHash(a:int, b:int):int { // func123
  return a[0]:int +
         ((a[4]:int + a[3]:int << 3) + 12) *
         (select_if(-1, -1 << (a = a[20]:ubyte) ^ -1, a > 31) & b)
}

function runtime_hashmapSet(a:int, b:int, c:int, d:int) { // func124
  var e:int;
  var h:int_ptr;
  var g:byte_ptr;
  var i:ubyte_ptr;
...
function runtime_fastrand():int { // func125
  var a:int;
  data[0]:int =
...
function runtime_hashmapNext(a:int, b:int, c:int, d:int):int { // func126
...
function runtime_reflectValueEqual(a:ubyte_ptr, b:int, c:int, d:int, e:int, f:int):int { // func127
  var h:int;
  var k:int;
  var l:int;
  var i:int;
...
function runtime_stringEqual(a:ubyte_ptr, b:int, c:ubyte_ptr, d:int):int { // func128
  var e:int;
  if (b != d) goto B_a;
  b = select_if(b, 0, b > 0);
  loop L_b {
...
function runtime_interfaceTypeAssert(a:int) { // func129
  var b:int;
  a = {
        if (g_b == 2) {
          g_c[0]:int = g_c[0]:int - 4;
...
function runtime_stringLess(a:ubyte_ptr, b:int, c:ubyte_ptr, d:int):int { // func130
  var f:int;
  var g:int;
...
function runtime_stringFromUnicode(a:{ a:int, b:int }, b:int) { // func131
  var c:int;
  var f:int;
  var g:int;
  var e:int;
...
function interface_Align_func_AssignableTo_func_named_reflect_Type_bool_Bits_func_CanSeq_func_bool_CanSeq2_fu(a:ubyte_ptr, b:int):int { // func132
  var c:int;
  a = {
        if (g_b == 2) {
          g_c[0]:int = g_c[0]:int - 4;
...
function reflect_toType(a:{ a:int, b:int }, b:int, c:{ a:int, b:int, c:int }) { // func133
  var d:{ a:int, b:int, c:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 12;
    c = g_c[0]:int;
...
function reflect_TypeOf(a:{ a:int, b:int }, b:int) { // func134
  var e:int_ptr;
  var d:{ a:int, b:int, c:int, d:int, e:int }
  var f:int;
  var c:{ a:int, b:int, c:int, d:int, e:int }
...
function Elem_2(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int) { // func135
  var f:int;
  var h:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
...
function Field_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int, e:int) { // func136
  var g:int;
  var i:int;
...
function Index_1(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int, e:int) { // func137
  var g:int;
  var i:int;
  var h:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }
...
function interface_Align_func_AssignableTo_func_named_reflect_Type_bool_Bits_func_CanSeq_func_bool_CanSeq2_fu_1(a:{ a:int, b:int }, b:int, c:int) { // func138
  var d:{ a:int, b:int, c:int, d:int }
  var e:{ a:int, b:int, c:int, d:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 16;
...
function internal_fmtsort_Sort_1(a:int, b:int, c:int, d:int_ptr, e:int, f:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }, g:int, h:int, i:int, j:int, k:int, l:int):int { // func139
  var m:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 32;
    f = g_c[0]:int;
...
function internal_fmtsort_compare(a:int, b:int, c:int, d:int, e:int, f:int):int { // func140
  var g:int;
  var j:int;
  var h:int;
  var k:int;
...
function slices_insertionSortCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:int, d:int) { // func141
  var g:int_ptr;
  var i:int;
...
function slices_symMergeCmpFunc_internal_fmtsort_KeyValue(a:int_ptr, b:int, c:int, d:int, e:int) { // func142
  var h:int_ptr;
  var j:int;
  var f:int;
  var w:int;
...
function slices_swapRangeCmpFunc_internal_fmtsort_KeyValue(a:int, b:int, c:long_ptr@4, d:int, e:int) { // func143
  var o:int;
  var i:int;
  a = {
        if (g_b == 2) {
...
function cmp_isNaN_string(a:int, b:int):int { // func144
  return runtime_stringEqual(a, b, a, b) ^ 1
}

function internal_fmtsort_nilCompare(a:{ a:int, b:byte }, b:int, c:int, d:int, e:int, f:int, g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }) { // func145
  var i:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 28;
    g = g_c[0]:int;
...
function time_appendInt(a:{ a:int, b:int, c:int }, b:int, c:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }, d:int, e:int, f:int) { // func146
  var g:int;
  var j:int;
  var h:int;
  var k:int;
...
function lookup(a:{ a:int, b:int, c:int }, b:int, c:long) { // func147
  var d:int;
  var l:int;
  var e:int;
  var f:int;
...
function time_tzsetName(a:{ a:int, b:int, c:int, d:int, e:byte }, b:ubyte_ptr, c:int) { // func148
  var g:int;
  var d:int;
  var h:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var e:int;
...
function time_tzsetOffset(a:{ a:int, b:int, c:int, d:byte }, b:ubyte_ptr, c:ubyte_ptr) { // func149
...
function time_tzsetRule(a:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:byte }, b:ubyte_ptr, c:ubyte_ptr) { // func150
...
function yearYday(a:{ a:int, b:int }, b:long) { // func151
  var d:int;
  var f:int;
  var e:int;
...
function time_tzruleTime(a:int, b:int, c:int, d:int, e:int, f:int, g:int):int { // func152
  var h:int;
  var i:int;
...
function time_tzsetNum(a:{ a:int, b:int, c:int, d:byte }, b:int, c:int, d:int, e:int) { // func153
  var j:int;
  var i:int;
...
function split(a:{ a:long, b:int, c:int }, b:long) { // func154
  var c:long;
...
function date(a:{ a:int, b:int, c:int }, b:long) { // func155
  var d:int;
  var e:int;
...
function clock(a:{ a:int, b:int, c:int }, b:long) { // func156
  var c:int;
  var d:int;
...
function String_6(a:{ a:int, b:int }, b:int) { // func157
  var c:int;
  var e:{ a:int, b:int, c:int, d:int, e:int }
  var d:int;
  var g:long;
...
function GoString(a:{ a:int, b:int }, b:long, c:long, d:{ a:int, b:int }) { // func158
  var e:int;
  var f:int;
  var g:int_ptr;
  var l:int;
...
function Write_1(a:{ a:int, b:int, c:int }, b:int, c:int, d:int) { // func159
  var h:int;
  var f:int;
  var g:int;
...
function strconv_appendQuotedWith(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int) { // func160
  var f:int;
  var j:int;
  var g:int;
  var m:int;
...
function strconv_appendEscapedRune(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int, f:int, g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }) { // func161
  var h:int;
  var k:int;
  var j:int;
...
function strconv_IsPrint(a:int):int { // func162
  var c:int;
  var b:int;
  var d:int;
  var g:int;
...
function strconv_bsearch_uint16_uint16(a:{ a:int, b:byte }, b:int, c:int, d:int) { // func163
  var e:int;
  var j:int;
  var h:int;
  a = {
...
function strconv_leftShift(a:int, b:int) { // func164
  var d:int;
  var c:int;
  var f:ubyte_ptr;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int }
...
function strconv_trim(a:int_ptr) { // func165
  var c:int;
  a = {
        if (g_b == 2) {
          g_c[0]:int = g_c[0]:int - 4;
...
function strconv_rightShift(a:int, b:int) { // func166
  var d:int;
  var c:int;
  var i:int;
  var h:byte_ptr;
...
function strconv_formatBits(a:{ a:int, b:int, c:int, d:int, e:int }, b:int, c:int, d:int, e:long, f:int) { // func167
  var h:int;
  var k:int;
  var g:int;
  var l:int;
...
function strconv_formatDigits(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int, f:int, g:int, h:int, i:int, j:int, k:int) { // func168
  var l:int;
...
function strconv_fmtE(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int, f:int, g:int, h:int, i:int, j:int) { // func169
  var k:int;
  var l:int;
  var n:int;
...
function strconv_fmtF(a:{ a:int, b:int, c:int }, b:int, c:int, d:int, e:int, f:int, g:int, h:int, i:int) { // func170
  var m:int;
  var j:int;
  var k:int;
  var l:int;
...
function strconv_mult128bitPow10(a:{ a:long, b:int, c:byte }, b:long, c:int, d:int) { // func171
  var f:int;
  var g:long;
  var h:long;
  a = 
...
function strconv_divisibleByPower5(a:long, b:int):int { // func172
  var d:long;
  var c:int;
  if (eqz(a)) {
    c = 1;
...
function strconv_formatDecimal(a:int_ptr, b:long, c:int, d:int, e:int) { // func173
  var g:int;
  var k:int;
  var i:long;
  var h:long;
...
function strconv_mult64bitPow10(a:{ a:int, b:int, c:byte }, b:int, c:int, d:int) { // func174
  var g:long;
  var f:int;
  a = 
    {
...
function strconv_ryuDigits(a:{ a:int, b:int, c:int, d:int, e:int }, b:long, c:long, d:long, e:int, f:int) { // func175
  var k:int_ptr;
  var j:int;
  var n:int;
  var l:int;
...
function strconv_divmod1e9(a:{ a:int, b:int }, b:long) { // func176
  var d:long;
...
function strconv_ryuDigits32(a:int_ptr, b:{ a:int, b:int }, c:int, d:int, e:int, f:int, g:{ a:int, b:int }) { // func177
  var i:int;
  var h:int;
  var j:int;
  if (g_b == 2) {
...
function strconv_appendQuotedRuneWith(a:{ a:int, b:int, c:int }, b:byte_ptr, c:int, d:int) { // func178
  var e:int;
  var h:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
...
function write_1(a:int, b:int, c:int) { // func179
  var e:int;
  a = {
        if (g_b == 2) {
          g_c[0]:int = g_c[0]:int - 4;
...
function writeRune(a:int, b:int) { // func180
  var e:int;
  var c:int = stack_pointer - 32;
  stack_pointer = c;
  c[7]:int = 0;
...
function writeString(a:int, b:int, c:int) { // func181
  var e:int;
  a = {
        if (g_b == 2) {
          g_c[0]:int = g_c[0]:int - 4;
...
function fmtBx(a:int, b:int, c:int, d:{ a:int, b:int, c:int, d:int }) { // func182
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 16;
    d = g_c[0]:int;
    a = d.a;
...
function fmtSbx(a:int, b:int, c:int, d:int, e:int, f:ubyte_ptr) { // func183
  var g:int;
  var k:int;
  var h:{ a:int, b:int, c:int }
  var i:int;
...
function fmtFloat(a:int, b:double, c:int, d:int, e:int) { // func184
  var f:int;
  var j:ubyte_ptr;
  var l:int;
  var g:int;
...
function pad(a:int, b:int, c:int, d:int) { // func185
  var g:int;
  var k:int;
  var e:int;
  var l:int;
...
function writePadding(a:int, b:{ a:int, b:int, c:int }) { // func186
  var c:int;
  var d:int;
  var f:int;
  var k:int;
...
function fmtInteger(a:int, b:long, c:int, d:int, e:int, f:ubyte_ptr) { // func187
  var l:int;
  var p:int;
  var h:int;
  var m:int;
...
function fmtQ(a:ubyte_ptr, b:int, c:int) { // func188
  var d:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }
  var f:int;
...
function truncateString(a:{ a:int, b:int }, b:int, c:int, d:int) { // func189
  var h:int;
  var g:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
...
function padString(a:int, b:int, c:int) { // func190
  var f:int;
  var i:int;
  var e:int;
  var g:int;
...
function fmtS(a:int, b:int, c:int) { // func191
  var f:int_ptr;
  var g:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int }
  var d:{ a:int, b:int, c:int, d:int, e:int, f:int }
...
function fmtSx(a:int, b:int, c:int, d:{ a:int, b:int, c:int, d:int }) { // func192
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 16;
    d = g_c[0]:int;
    a = d.a;
...
function argNumber(a:{ a:int, b:int, c:byte }, b:byte_ptr, c:int, d:ubyte_ptr, e:int, f:int) { // func193
...
function fmt_parsenum(a:{ a:int, b:byte, c:int }, b:{ a:int, b:int, c:int, d:int }, c:int, d:int, e:int) { // func194
  var g:int;
...
function badVerb(a:int, b:int) { // func195
...
function printValue(a:int, b:int, c:{ a:int, b:int, c:int }, d:int, e:int, f:int) { // func196
  var g:int;
  var h:ubyte_ptr;
  var i:int;
...
function fmt0x64(a:int, b:long, c:int) { // func197
  var e:int;
  var d:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 20;
...
function fmtBool(a:int, b:{ a:int, b:int }, c:{ a:int, b:int }) { // func198
  var d:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 8;
    c = g_c[0]:int;
...
function fmtBytes(a:int, b:int, c:int, d:int, e:int, f:int, g:{ a:int, b:int, c:int }) { // func199
  var i:int;
  var j:int;
  var k:int;
  var h:int;
...
function fmtComplex(a:int, b:double, c:double, d:int, e:int) { // func200
  var g:int;
  var h:int;
  var f:int;
  if (g_b == 2) {
...
function fmtFloat_1(a:int, b:double, c:int, d:int) { // func201
  var e:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 20;
    d = g_c[0]:int;
...
function fmtInteger_1(a:int, b:long, c:int, d:byte_ptr) { // func202
  var g:int;
  var m:int;
  var f:int;
  var i:int;
...
function fmtPointer(a:ubyte_ptr, b:ubyte_ptr, c:int, d:int, e:int) { // func203
  var f:int;
  var i:int;
  var g:int;
  var h:int;
...
function fmtString(a:ubyte_ptr, b:int, c:int, d:{ a:int, b:int, c:int, d:int }) { // func204
  var e:{ a:int, b:int, c:int, d:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 16;
    d = g_c[0]:int;
...
function handleMethods(a:int, b:int):int { // func205
  var c:int;
  var e:int;
  var d:int;
  var g:int;
...
function fmt_intFromArg(a:{ a:int, b:byte }, b:{ a:int, b:int }, c:int) { // func206
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }
  var d:int;
  var e:ubyte_ptr;
  var h:int;
...
export function asyncify_start_unwind(a:int) { // func207
  g_b = 1;
  g_c = a;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_stop_unwind() { // func208
  g_b = 0;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_start_rewind(a:int) { // func209
  g_b = 2;
  g_c = a;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_stop_rewind() { // func210
  g_b = 0;
  if (g_c[0]:int > g_c[1]:int) { unreachable }
}

export function asyncify_get_state():int { // func211
  return g_b
}
