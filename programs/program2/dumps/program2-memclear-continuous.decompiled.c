...
data data(offset: 87632) =
  "D\f8\5c\ff\f8^\01\00\00\00\00\00\e4_\01\00aQ\86A\00\00\00\00\04\00\00\00"
  "\08\00\00\00\01\00\00\00\00\00\00\00\02\00\00\00\00\00\00\00\03\00\00\00"
  "\bc`\01\00\c1\82\01\00\00\00\00\00\04\00\00\00\0c\00\00\00\01\00\00\00"
...
function Push(a:int_ptr) { // func76
  ...
  a = {
        ...
        if (eqz(g_b)) {
          var c:int_ptr = 90080[0]:int;
          if (c) { c[0] = a }
          90080[0]:int = a;
          if (a) {
            a[0] = 0;
            if (eqz(90076[0]:int)) { 90076[0]:int = a }
            return ;
          }
        }
        if (eqz(g_b) | eqz(b)) {
...
function runtime_putchar(a:int) { // func82
  ...
  a = {
        ...
        if (eqz(g_b) | eqz(c)) {
          runtime_fd_write(1, 87636, 1, 90056);
          0;
          if (g_b == 1) goto B_a;
        }
...
export function malloc(a:int):int { // func84
  ...
  c = {
        ...
        if (eqz(g_b) | f == 1) {
          runtime_hashmapBinarySet(87684, a, b);
          1;
          if (g_b == 1) goto B_b;
        }
        label B_f:
...
export function free(a:int) { // func86
  ...
  c = {
        ...
        if (eqz(g_b) | eqz(e)) {
          runtime_hashmapBinaryGet(87684, b, d, 12);
          let t0 = 0;
          if (g_b == 1) goto B_b;
          b = t0;
        }
  ...
  b = 
    {
      ...
      if (eqz(g_b)) {
        ...
        d = runtime_hashmapBucketAddrForHash(87684, c);
      }
      loop L_h {
        if (eqz(g_b)) {
          e[2]:int = d;
        ...
        loop L_k {
          if (eqz(g_b)) {
            g = c == 8;
            if (g) goto B_l;
            e[4]:int = (g = k + (l = data[16]:int) * c);
            f = j != (m = c + d)[0]:ubyte;
          }
          if (eqz(g_b)) {
            if (f) goto B_n;
            e[5]:int = (n = data[19]:int);
            e[6]:int = (f = data[20]:int);
            if (eqz(f)) goto B_j;
          }
          if (eqz(g_b) | i == 1) {
          ...
          if (eqz(g_b)) {
            ...
            if (f) goto B_n;
            m[0]:byte = 0;
            memory_fill(g, 0, data[16]:int);
            memory_fill(d + (data[16]:int << 3) + (g = data[17]:int) * c + 12, 0, g);
            data[15]:int = data[15]:int - 1;
            goto B_g;
          }
          label B_n:
          if (eqz(g_b)) {
...
export function realloc(a:int, b:int):int { // func90
  ...
  d = {
        ...
        if (eqz(g_b) | g == 2) {
          runtime_hashmapBinaryGet(87684, e, c, 12);
          let t1 = 2;
          if (g_b == 1) goto B_b;
          e = t1;
        }
  ...
  c = {
        ...
        loop L_r {
          ...
          if (eqz(g_b)) {
            ...
            b = eqz(a);
            if (b) goto B_u;
            90076[0]:int = (b = a[0]:int);
            d.j = b;
            d.k = (b = 90080[0]:int);
            b = a != b;
            if (eqz(b)) { 90080[0]:int = 0 }
            a[0]:int = 0;
          }
          if (eqz(g_b) | e == 9) {
...
function runtime_RegisterTask(a:int, b:{ a:int, b:int, c:int, d:int, e:int }) { // func93
  var c:int_ptr;
  var e:int;
  var f:int;
  var g:int;
  ...
  b = {
        ...
        if (eqz(g_b) | eqz(g)) {
          runtime_hashmapBinarySet(d, a, c);
          0;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b) | g == 1) {
          runtime_scheduleLogTask(67800, 6, f);
          1;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) {
...
function runtime_scheduleLogTask(a:int, b:int, c:int) { // func95
  ...
  e = {
        ...
        if (eqz(g_b)) {
          ...
          stack_pointer = d;
          d[31]:int = 10;
          memory_fill(d + 132, 0, 36);
          d[30]:int = (o = 90052[0]:int);
          90052[0]:int = d + 120;
          d[32]:int = (j = 89976[0]:int);
          d[29]:int = c;
          f = d + 168;
          c = d + 116;
        }
        if (eqz(g_b) | eqz(h)) {
          runtime_hashmapBinaryGet(j, c, f, 8);
          let t0 = 0;
          if (g_b == 1) goto B_b;
          c = t0;
        }
        ...
        c = {
              ...
              if (eqz(g_b) | h == 3) {
                runtime_stringConcat(a, b, f, c, j);
                3;
                if (g_b == 1) goto B_b;
              }
              if (eqz(g_b)) {
        ...
        if (eqz(g_b) | h == 15) {
          runtime_stringConcat(d, c, j, b, a);
          15;
          if (g_b == 1) goto B_b;
        }
        if (eqz(g_b)) {
...
function runtime_run_1() { // func97
  ...
  c = {
        ...
        if (eqz(g_b)) {
          90664[0]:long@4 = (k = a[13]:long@4);
          90660[0]:int = (g = a[12]:int);
          a[24]:int = g;
          a[25]:int = (i = 90060[0]:int);
          d = eqz(i);
        }
        if (eqz(g_b)) {
          if (eqz(d)) {
        ...
        if (eqz(g_b)) {
          b[0]:long = k - j >> 16L & 17592186044415L;
          a[47]:int = b;
          a[48]:int = b;
          a[21]:int = b;
          a[20]:int = 86848;
...
function runtime_alloc_1(a:int):int { // func104
  var b:int;
  var g:int;
  var c:int;
  var e:int;
  ...
  f = {
        ...
        if (eqz(g_b)) {
          if (eqz(a)) { return 90048 }
          90008[0]:long = 90008[0]:long + i64_extend_i32_u(a);
          90024[0]:long = 90024[0]:long + 1L;
          90016[0]:long =
            (h = 90016[0]:long + i64_extend_i32_u(i = a + 15 >> 4));
          j = 0;
          b = 89996[0]:int;
          g = b;
          c = 0;
...
function runtime_markRoots(a:int_ptr, b:int) { // func105
  var d:int;
...
function state(a:int):int { // func106
  return (89992[0]:int + (a >> 2))[0]:ubyte >> (a << 1 & 6) & 3
}

function markFree(a:int) { // func107
  var b:int = 89992[0]:int + (a >> 2);
...
function runtime_growHeap():int { // func108
  ...
  c = {
        ...
        if (eqz(g_b)) { memory_copy(89992[0]:int, a, b - a) }
        label B_e:
        if (eqz(g_b)) { return d }
        unreachable;
        label B_b:
...
function runtime_startMark(a:int) { // func109
  var h:int_ptr;
  var d:int_ptr;
  var e:int;
...
function runtime_Gosched() { // func113
  ...
  b = {
        ...
        if (eqz(g_b)) {
          a = stack_pointer - 16;
          stack_pointer = a;
          89984[0]:long = (e = 89984[0]:long + 1L);
          a.d = 0;
          a.b = 2;
          c = 90052[0]:int;
          90052[0]:int = a;
...
function runtime_panicOrGoexit(a:int, b:{ a:int, b:int }) { // func123
  var c:{ a:int, b:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 8;
    b = g_c[0]:int;
...
function runtime_printitf(a:int, b:int) { // func124
  var e:int;
  var f:int;
  var c:int;
  var d:int;
...
function interface_Error_func_string_typeassert(a:int):int { // func125
  return 
...
function interface_String_func_string_typeassert(a:int):int { // func126
  return 
...
function interface_String_func_string_String_invoke(a:{ a:int, b:int }, b:int, c:{ a:int, b:int }) { // func127
  var d:int_ptr;
  var e:int;
  var g:int;
  var h:long;
...
function String_3(a:{ a:int, b:int }, b:long, c:long, d:int) { // func128
  var e:int;
  var n:int;
  var k:int;
...
function get(a:{ a:int, b:int, c:int }):int { // func129
  var b:int;
  var e:{ a:int, b:int, c:int, d:int }
  var d:int;
  var c:{ a:int, b:int, c:int, d:int }
...
function String_4(a:{ a:int, b:int }, b:int) { // func130
  var e:int_ptr;
  var f:int;
  var c:{ a:int, b:int, c:int, d:int, e:int }
  var d:{ a:int, b:int, c:int, d:int, e:int }
...
function String_5(a:{ a:int, b:int }, b:int) { // func131
  var c:int;
  var g:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
  var d:byte_ptr;
