  ...
  d = {
        ...
        loop L_k {
          ...
          if (eqz(g_b)) {
            ...
            b = eqz(a);
            if (b) goto B_n;
            89732[0]:int = (b = a[0]:int);
            c.f = b;
            c.g = (b = 89736[0]:int);
            b = a != b;
            if (eqz(b)) { 89736[0]:int = 0 }
            a[0]:int = 0;
          }
          if (eqz(g_b) | e == 5) {
  ...
  b = 
    {
      ...
      loop L_f {
        ...
        loop L_ba {
          ...
          if (eqz(g_b)) {
            br_table[B_ma, B_ka, B_ja, ..B_ea](c - 1)
            label B_ma:
            markFree(a);
          }
          if (eqz(g_b) | b == 13) {
          ...
          if (eqz(g_b)) goto B_fa;
          label B_ja:
          if (eqz(g_b)) {
            d[3]:int = (c = 89648[0]:int);
            c = (a >> 2) + c;
            e = c[0]:ubyte & (2 << (a << 1 & 6) ^ -1);
            c[0]:byte = e;
            e = 0;
          }
          if (eqz(g_b) | b == 15) {
          ...
          if (eqz(g_b)) goto B_ea;
          label B_ga:
          if (eqz(g_b)) { 89696[0]:long = (f = 89696[0]:long + f) }
          if (eqz(g_b) | b == 16) {
            runtime_Gosched();
            16;
            if (g_b == 1) goto B_b;
          ...
          e = select_if(e, 1, g_b);
          label B_ea:
          a = select_if(a, a + 1, g_b);
          if (eqz(g_b) | b == 17) {
            runtime_Gosched();
            17;
            if (g_b == 1) goto B_b;
          }
          if (eqz(g_b)) continue L_ba;
        }
      }
      return ;
      label B_b:
  ...
  b = {
        ...
        loop L_g {
          ...
          loop L_u {
            ...
            if (eqz(g_b)) { d = 89648[0]:int }
            if (eqz(g_b) | b == 9) {
              runtime_Gosched();
              9;
              if (g_b == 1) goto B_b;
            }
            e = select_if(e, c < 90368, g_b);
            if (eqz(g_b)) {
              if (e) goto B_aa;
              e = c >= d;
              if (e) goto B_aa;
