  ...
  b = 
    {
      ...
      loop L_f {
        ...
        if (eqz(g_b)) {
          br_table[B_i, B_k, ..B_m](b)
          label B_m:
          if (memory_grow(memory_size()) == -1) goto B_h;
          b = memory_size();
          e = 89548[0]:int;
          89548[0]:int = b << 16;
          b = 89696[0]:int;
          runtime_calculateHeapAddresses();
          memory_copy(89696[0]:int, b, e - b);
        }
        if (eqz(g_b) | eqz(g)) {
...
export function start() { // func91
  ...
  d = {
        ...
        if (eqz(g_b)) {
          ...
          c.a = (f = 89756[0]:int);
          89756[0]:int = c;
          89548[0]:int = (b = memory_size() << 16);
          runtime_calculateHeapAddresses();
          c.d = (a = 89696[0]:int);
          c.c = a;
          memory_fill(a, 0, b = b - a);
        }
        if (eqz(g_b) | eqz(e)) {
          arc4random();
          let t0 = 0;
        ...
        loop L_k {
          ...
          if (eqz(g_b)) {
            ...
            b = eqz(a);
            if (b) goto B_n;
            89780[0]:int = (b = a[0]:int);
            c.f = b;
            c.g = (b = 89784[0]:int);
            b = a != b;
            if (eqz(b)) { 89784[0]:int = 0 }
            a[0]:int = 0;
          }
          if (eqz(g_b) | e == 5) {
      ...
      loop L_f {
        ...
        loop L_u {
          ...
          loop L_x {
            ...
            if (select_if(g_b, 1, c = select_if(c, (c & 255) != 3, g_b))) {
              if (eqz(g_b) | a == 14) {
                runtime_startMark(b);
                14;
                if (g_b == 1) goto B_b;
        ...
        loop L_ha {
          ...
          c = select_if(c, c & 255, g_b);
          if (eqz(g_b)) {
            br_table[B_sa, B_qa, B_pa, ..B_ka](c - 1)
            label B_sa:
            markFree(b);
          }
          if (eqz(g_b) | a == 19) {
          ...
          label B_pa:
          if (eqz(g_b)) {
            d[3]:int = (c = 89696[0]:int);
            c = (b >> 2) + c;
            e = c[0]:ubyte & (2 << (b << 1 & 6) ^ -1);
            c[0]:byte = e;
            e = 0;
          }
          if (eqz(g_b) | a == 21) {
          ...
          if (eqz(g_b)) goto B_ka;
          label B_ma:
          if (eqz(g_b)) { 89744[0]:long = (f = 89744[0]:long + f) }
          if (eqz(g_b) | a == 22) {
            runtime_Gosched();
            22;
            if (g_b == 1) goto B_b;
          ...
          e = select_if(e, 1, g_b);
          label B_ka:
          b = select_if(b, b + 1, g_b);
          if (eqz(g_b) | a == 26) {
            runtime_Gosched();
            26;
            if (g_b == 1) goto B_b;
          }
          if (eqz(g_b)) continue L_ha;
        }
      }
      return ;
      label B_b:
...
function setState(a:int, b:int) { // func106
  var c:int = 89696[0]:int + (a >> 2);
  c[0]:byte = c[0]:ubyte | b << (a << 1 & 6);
}

function runtime_printint32(a:int) { // func107
  var b:int;
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 4;
    a = (g_c[0]:int)[0]:int;
...
function runtime_stringEqual(a:ubyte_ptr, b:int, c:ubyte_ptr, d:int):int { // func108
  var e:int;
  if (b != d) goto B_a;
  b = select_if(b, 0, b > 0);
  loop L_b {
...
function runtime_hashmapGet(a:int_ptr, b:int, c:int, d:int):int { // func109
  var f:int;
  var j:int;
  var h:int_ptr;
  var g:int;
...
function runtime_hashmapBucketAddrForHash(a:int, b:int):int { // func110
  return a[0]:int +
         ((a[4]:int + a[3]:int << 3) + 12) *
         (select_if(-1, -1 << (a = a[20]:ubyte) ^ -1, a > 31) & b)
}

function runtime_Gosched() { // func111
...
function runtime_markRoots(a:int_ptr, b:int) { // func112
  var g:int;
  var h:int;
...
function runtime_startMark(a:int_ptr) { // func113
  var f:int;
  var h:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }
  var i:int;
  var b:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }
  ...
  b = {
        ...
        loop L_g {
          ...
          if (eqz(g_b)) {
            i = c << 4;
            br_table[B_p, B_o, B_p, ..B_o]((state(c) & 255) - 1)
            label B_p:
            c = c + 1;
            label B_o:
            a = i + 90416;
          ...
          loop L_u {
            ...
            if (eqz(g_b)) { d = 89696[0]:int }
            if (eqz(g_b) | b == 9) {
              runtime_Gosched();
              9;
              if (g_b == 1) goto B_b;
            }
            e = select_if(e, c < 90416, g_b);
            if (eqz(g_b)) {
              if (e) goto B_aa;
              e = c >= d;
              if (e) goto B_aa;
...
function markFree(a:int) { // func114
  var b:int = 89696[0]:int + (a >> 2);
  b[0]:byte = b[0]:ubyte & (3 << (a << 1 & 6) ^ -1);
}

function runtime_panicOrGoexit(a:int, b:{ a:int, b:int }) { // func115
  var c:{ a:int, b:int }
  if (g_b == 2) {
    g_c[0]:int = g_c[0]:int - 8;
    b = g_c[0]:int;
...
function runtime_printitf(a:int, b:int) { // func116
  var e:int;
  var f:int;
  var c:int;
  var d:int;
...
function interface_Error_func_string_typeassert(a:int):int { // func117
  return 
...
function interface_String_func_string_typeassert(a:int):int { // func118
  return 
...
function interface_String_func_string_String_invoke(a:{ a:int, b:int }, b:int, c:{ a:int, b:int }) { // func119
  var d:int_ptr;
  var e:int;
  var g:int;
  var h:long;
...
function String_3(a:{ a:int, b:int }, b:long, c:long, d:int) { // func120
  var e:int;
  var n:int;
  var k:int;
...
function get(a:{ a:int, b:int, c:int }):int { // func121
  var b:int;
  var e:{ a:int, b:int, c:int, d:int }
  var d:int;
  var c:{ a:int, b:int, c:int, d:int }
...
function String_4(a:{ a:int, b:int }, b:int) { // func122
  var e:int_ptr;
  var f:int;
...
function String_5(a:{ a:int, b:int }, b:int) { // func123
  var c:int;
...
function findHead(a:int):int { // func124
  var b:int;
...
function fmt_newPrinter():int { // func125
  var b:int_ptr;
  var a:int;
  var c:int;
  var d:{ a:int, b:int, c:int, d:int, e:int }
...
function writeByte(a:int, b:int) { // func126
  var c:int;
  var g:int;
  var f:int;
  var e:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int }
...
function printArg(a:int, b:int, c:int, d:int) { // func127
  var i:int_ptr;
  var g:int;
  var e:int;
  var f:long;
...
function Write(a:{ a:int, b:int, c:int }, b:int_ptr, c:int, d:int) { // func128
  var e:int_ptr;
  var f:{ a:int, b:int, c:int, d:int, e:int, f:int }
  var g:int;
  var i:int;
...
function fmt_Printf(a:{ a:int, b:int }, b:byte_ptr, c:int, d:{ a:int, b:int }) { // func130
  var h:int;
  var j:int;
  var g:int;
  var e:byte_ptr;
